...
public class TestWindowedBoltExecutor {
    ...
    private static class TestInput {
        ...
        public TestInput(Map<String, Object> conf,String fieldName, long[] timestamps, String componentId, String srcComponent, Integer taskId, Map<String, Optional<?>> restoreState, MockWindowedBolt mock, Set<String> str) {
